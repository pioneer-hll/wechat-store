...
//购物车的商品删除
const cartDel = (params) => wxRequest(params, 'http://www.wechat.cn/shop/deleteCart');
//const cartDel = (params) => wxRequest(params, apiMall + '/api/mall/goodsCart/delete');
//购物车的商品数量更新
const cartUpdateNum = (params) => wxRequest(params, 'http://www.wechat.cn/shop/updateNum');
...
//商品分类--begin
//一级分类
 const rootCtegoryList = (params) => wxRequest(params, 'https://weapp.sphvip.com/shop/topcategorylist');
//const rootCtegoryList = (params) => wxRequest(params, apiMall + '/api/mall/rootCtegoryList');



//二级三级分类
const childGoodsCatetoryList = (params) => wxRequest(params, 'https://weapp.sphvip.com/shop/categorylist');
